...
if __name__ == '__main__':
    ...
    for i in range(len(cf.get("raw_data", "turn_around_filename").split(","))):
        print "start deal with file name is " + cf.get("raw_data", "turn_around_filename").split(",")[i]
        print "\n\n===========================================\n\n"
        try:
            get_thw(cf.get("raw_data", "path"),
                    cf.get("raw_data", "turn_around_filename").split(",")[i],
