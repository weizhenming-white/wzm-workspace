...
brief:增加前广角相机 link fs_handle_tmp_2，优化处理速度
"""
        ...
        try:
            ...
            for item in time_data.keys():
                ...
                os.system('/home/holo/workspace/hpp_20201104/target/bin/ros/export_3d_data_cmw '
                          ...
                          '/home/holo/workspace/hpp_20201104/target/config/holo_data_provider/app_config/camera_tmp.yaml '
                          '--start %d --range %d -o %s '
                          '--output_camera_image 1' % (bag, item - start_time, 1, 'picture' + '/' + export_path))
...
if __name__ == '__main__':
    ...
    bag_path = []
    # bag_path = ['/home/holo/perception_data_filter/data/2020-11-30-14-35-53_hpp_11.bag']
