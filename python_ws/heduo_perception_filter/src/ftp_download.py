...
class FTPSync(object):
    ...
    def get_file(self, ftp_path, start_date):
        # print(ftp_path)
        path_list = []
        bag_list = []
    ...
    def download(self, bag_list, local_path):
        # 下载对应的bag
...
if __name__ == '__main__':
    ...
    bag_list = ftp.get_file('/Rosbag_parking/weltmeister', 20201201)  # FTP路径，开始时间，本地存放bag的路径
    ftp.download(bag_list, '/home/holo/perception_data_filter/data')
    ftp.close()